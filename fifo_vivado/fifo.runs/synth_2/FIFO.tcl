...
synth_design -top FIFO -part xcvu13p-fhga2104-3-e


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef FIFO.dcp
create_report "synth_2_synth_report_utilization_0" "report_utilization -file FIFO_utilization_synth.rpt -pb FIFO_utilization_synth.pb"
